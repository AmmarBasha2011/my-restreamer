...
const ffmpegArgs = [
    ...
    // --- الحل الجذري للصوت لمعالجة قنوات الـ 5.1 والـ 1.4 وغيرها ---
    '-af', 'aconvert=stereo,aresample=async=1', // فلتر إجبار التحويل إلى ستيريو وتزامن الصوت تلقائياً
    '-c:a', 'aac',                             // إعادة ترميز إجبارية لكل القائمة بالتساوي
